...
fun RELrep (ARG0 : Lint Llist, ARG1 : (Lint Llist , Lint Llist) TUPLETYPE2)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Llist (fn L : Lint Llist =>
...
, (SMLOG.EXISTS Llist (fn L2 : Lint Llist =>
(SMLOG.EXISTS Llist (fn M : Lint Llist =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG1 (TUPLECON2 ((Lopcoco (TUPLECON2 (X, M))
)
, L2))
 ARGtc)
)))
, (RELrep (XS, (TUPLECON2 (M, L2))
))
))
))
))
...
fun rep (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
...
fun RELrepconcat (ARG0 : (Lint Llist , Lint Llist) TUPLETYPE2, ARG1 : (Lint Llist , Lint Llist) TUPLETYPE2, ARG2 : (Lint Llist , Lint Llist) TUPLETYPE2)  = (SMLOG.STEP (SMLOG.EXISTS Llist (fn L1 : Lint Llist =>
(SMLOG.EXISTS Llist (fn L2 : Lint Llist =>
(SMLOG.EXISTS Llist (fn M : Lint Llist =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
...
fun repconcat (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
(PRINTLint ARGt)
 ...
 (RELrepconcat (ARG0, ARG1, ARG2) (fn _ =>
()))
)
) (((fn (Option.SOME ARG0) =>
((EMBEDTUPLETYPE2 (((fn ARGt =>
...
fun RELconcat (ARG0 : Lint Llist, ARG1 : Lint Llist, ARG2 : Lint Llist)  = (SMLOG.STEP (SMLOG.EXISTS Llist (fn L1 : Lint Llist =>
(SMLOG.EXISTS Llist (fn L2 : Lint Llist =>
(SMLOG.EXISTS Llist (fn R : Lint Llist =>
(SMLOG.EXISTS TUPLETYPE2 (fn R1 : (Lint Llist , Lint Llist) TUPLETYPE2 =>
(SMLOG.EXISTS TUPLETYPE2 (fn R2 : (Lint Llist , Lint Llist) TUPLETYPE2 =>
...
, (RELrepconcat (R1, R2, (TUPLECON2 (R, (Lnil)
))
))
))
))
...
fun concat (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
