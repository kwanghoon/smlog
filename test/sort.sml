...
fun RELsort (ARG0 : Lint Llist, ARG1 : Lint Llist)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG1 (Lopcoco (TUPLECON2 (X, (Lopcoco (TUPLECON2 (Y, YS))
)
))
)
 ARGtc)
)))
, (RELsort (XS, (Lopcoco (TUPLECON2 (Y, YS))
)
))
))
, (fn ARGtc =>
...
, (RELsort ((Lopcoco (TUPLECON2 (X, YS))
)
, ZS))
))
))
...
fun sort (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
