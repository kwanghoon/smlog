...
(SMLOG.EXISTS Llist (fn ENV : (Lstring , Lvalue) TUPLETYPE2 Llist =>
(SMLOG.EXISTS Lnum (fn H : Lnum =>
(SMLOG.EXISTS Lvalue (fn ORPAT_51 : Lvalue =>
(SMLOG.EXISTS Lvalue (fn V : Lvalue =>
(SMLOG.EXISTS TUPLETYPE2 (fn WILD_49 : (Lvalue , Lvalue) TUPLETYPE2 =>
(SMLOG.EXISTS TUPLETYPE3 (fn WILD_50 : ((Lstring , Lvalue) TUPLETYPE2 Llist , (Lstring , Lty) TUPLETYPE2 Llist , (Lstring , Lty , Lstring , Lexp) TUPLETYPE4) TUPLETYPE3 =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLnum (ARG0, ARG1) ARGtc)
...
fun RELquery3 (ARG0 : Lnum, ARG1 : Lvalue)  = (SMLOG.STEP (SMLOG.EXISTS Lnum (fn H : Lnum =>
(SMLOG.EXISTS Lvalue (fn V : Lvalue =>
(SMLOG.EXISTS Lvalue (fn V1 : Lvalue =>
(SMLOG.EXISTS Lvalue (fn V2 : Lvalue =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
...
, (RELeval (H, (Lopcoco (TUPLECON2 ((TUPLECON2 ((THEstring "x")
, V))
, (Lnil)
))
)
...
fun query3 (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
fun RELquery4 (ARG0 : Lnum, ARG1 : Lvalue)  = (SMLOG.STEP (SMLOG.EXISTS Lnum (fn H : Lnum =>
(SMLOG.EXISTS Lvalue (fn V : Lvalue =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
...
fun query4 (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
