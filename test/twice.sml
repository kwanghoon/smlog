...
datatype OInt = datatype Int

datatype LInt = LInt of (Ostring * LInt Option.option ref) | LZero | LSucc of LInt

fun EMBEDLInt Zero  = LZero
| EMBEDLInt (Succ ARGt)  = (LSucc (EMBEDLInt ARGt)
)
...
| PROJLInt LZero  = Zero
| PROJLInt (LSucc ARGt)  = (Succ (PROJLInt ARGt)
)
...
| OCCURLInt ARG0 LZero  = false
| OCCURLInt ARG0 (LSucc ARG1)  = (OCCURLInt ARG0 ARG1)
...
| UNIFYLInt (LZero, LZero) ARGtc  = (true, ARGtc)
| UNIFYLInt ((LSucc ARGt1), (LSucc ARGt2)) ARGtc  = (UNIFYLInt (ARGt1, ARGt2) ARGtc)

| UNIFYLInt (_, _) ARGtc  = (false, ARGtc)

fun PRINTLInt (LInt (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLInt (LInt (_, (ref (Option.SOME ARGt))))  = (PRINTLInt ARGt)

| PRINTLInt LZero  = "Zero"
| PRINTLInt (LSucc ARGt)  = (String.concat ["Succ", " ", (PRINTLInt ARGt)
])


fun RELinc1 (ARG0 : LInt, ARG1 : LInt)  = (SMLOG.STEP (SMLOG.EXISTS LInt (fn N : LInt =>
...
fun inc1 (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
...
fun RELinc2 (ARG0 : LInt, ARG1 : LInt)  = (SMLOG.STEP (SMLOG.EXISTS LInt (fn N : LInt =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLInt (ARG0, ARG1) ARGtc)
...
fun inc2 (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
fun RELf (ARG0 : LInt, ARG1 : LInt)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS LInt (fn X : LInt =>
...
fun RELtwice (ARG0 : LInt, ARG1 : LInt)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS LInt (fn W : LInt =>
(SMLOG.EXISTS LInt (fn X : LInt =>
(SMLOG.EXISTS LInt (fn Y : LInt =>
...
fun twice (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
