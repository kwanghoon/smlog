...
(SMLOG.EXISTS Llist (fn L2 : Lstring Llist =>
(SMLOG.EXISTS Llist (fn L3 : Lstring Llist =>
(SMLOG.EXISTS Lvalue (fn ORPAT_5 : Lvalue =>
(SMLOG.EXISTS Lvalue (fn V : Lvalue =>
(SMLOG.EXISTS TUPLETYPE3 (fn WILD_1 : (Lvalue , Lvalue , Lstring) TUPLETYPE3 =>
(SMLOG.EXISTS Lstring (fn WILD_2 : Lstring =>
(SMLOG.EXISTS Lstring (fn WILD_3 : Lstring =>
(SMLOG.EXISTS TUPLETYPE4 (fn WILD_4 : ((Lstring , Lvalue) TUPLETYPE2 Llist , (Lstring , Lty) TUPLETYPE2 Llist , (Lstring , Lty , Lstring , Lexp) TUPLETYPE4 , Lstring) TUPLETYPE4 =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLnum (ARG0, ARG1) ARGtc)
