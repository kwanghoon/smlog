...
fun RELg (ARG0 : Lint, ARG1 : (Lint , Lint) TUPLETYPE2)  = (SMLOG.STEP (SMLOG.EXISTS Lint (fn X : Lint =>
...
fun RELf (ARG0 : Lint, ARG1 : (Lint , (Lint , Lint) TUPLETYPE2) TUPLETYPE2)  = (SMLOG.STEP (SMLOG.EXISTS Lint (fn X : Lint =>
(SMLOG.EXISTS TUPLETYPE2 (fn Y : (Lint , Lint) TUPLETYPE2 =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
