...
datatype OD1 = datatype D1

datatype OD2 = datatype D2

datatype LD1 = LD1 of (Ostring * LD1 Option.option ref) | LC11 | LC12 of LD2
and LD2 = LD2 of (Ostring * LD2 Option.option ref) | LC21 | LC22 of LD1

fun EMBEDLD1 C11  = LC11
| EMBEDLD1 (C12 ARGt)  = (LC12 (EMBEDLD2 ARGt)
)

and PROJLD1 (LD1 (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJLD1 (LD1 (_, (ref (Option.SOME ARGt))))  = (PROJLD1 ARGt)

| PROJLD1 LC11  = C11
| PROJLD1 (LC12 ARGt)  = (C12 (PROJLD2 ARGt)
)

and EMBEDLD2 C21  = LC21
| EMBEDLD2 (C22 ARGt)  = (LC22 (EMBEDLD1 ARGt)
)

and PROJLD2 (LD2 (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJLD2 (LD2 (_, (ref (Option.SOME ARGt))))  = (PROJLD2 ARGt)

| PROJLD2 LC21  = C21
| PROJLD2 (LC22 ARGt)  = (C22 (PROJLD1 ARGt)
)


fun OCCURLD1 ARG0 (LD1 (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURLD1 ARG0 (LD1 (_, (ref (Option.SOME ARG2))))  = (OCCURLD1 ARG0 ARG2)

| OCCURLD1 ARG0 LC11  = false
| OCCURLD1 ARG0 (LC12 ARG1)  = (OCCURLD2 ARG0 ARG1)

and OCCURLD2 ARG0 (LD2 (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURLD2 ARG0 (LD2 (_, (ref (Option.SOME ARG2))))  = (OCCURLD2 ARG0 ARG2)

| OCCURLD2 ARG0 LC21  = false
| OCCURLD2 ARG0 (LC22 ARG1)  = (OCCURLD1 ARG0 ARG1)


fun UNIFYLD1 (ARGt1, (LD1 (_, (ref (Option.SOME ARGt2))))) ARGtc  = (UNIFYLD1 (ARGt1, ARGt2) ARGtc)

| UNIFYLD1 (ARGt1, (LD1 (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) (OCCURLD1 ARG0 ARGt1)
)

| UNIFYLD1 ((LD1 (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = (UNIFYLD1 (ARGt1, ARGt2) ARGtc)

| UNIFYLD1 ((ARGt1 as (LD1 (_, (ref Option.NONE)))), ARGt2) ARGtc  = (UNIFYLD1 (ARGt2, ARGt1) ARGtc)

| UNIFYLD1 (LC11, LC11) ARGtc  = (true, ARGtc)
| UNIFYLD1 ((LC12 ARGt1), (LC12 ARGt2)) ARGtc  = (UNIFYLD2 (ARGt1, ARGt2) ARGtc)

| UNIFYLD1 (_, _) ARGtc  = (false, ARGtc)
and UNIFYLD2 (ARGt1, (LD2 (_, (ref (Option.SOME ARGt2))))) ARGtc  = (UNIFYLD2 (ARGt1, ARGt2) ARGtc)

| UNIFYLD2 (ARGt1, (LD2 (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) (OCCURLD2 ARG0 ARGt1)
)

| UNIFYLD2 ((LD2 (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = (UNIFYLD2 (ARGt1, ARGt2) ARGtc)

| UNIFYLD2 ((ARGt1 as (LD2 (_, (ref Option.NONE)))), ARGt2) ARGtc  = (UNIFYLD2 (ARGt2, ARGt1) ARGtc)

| UNIFYLD2 (LC21, LC21) ARGtc  = (true, ARGtc)
| UNIFYLD2 ((LC22 ARGt1), (LC22 ARGt2)) ARGtc  = (UNIFYLD1 (ARGt1, ARGt2) ARGtc)

| UNIFYLD2 (_, _) ARGtc  = (false, ARGtc)

fun PRINTLD1 (LD1 (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLD1 (LD1 (_, (ref (Option.SOME ARGt))))  = (PRINTLD1 ARGt)

| PRINTLD1 LC11  = "C11"
| PRINTLD1 (LC12 ARGt)  = (String.concat ["C12", " ", (PRINTLD2 ARGt)
])

and PRINTLD2 (LD2 (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLD2 (LD2 (_, (ref (Option.SOME ARGt))))  = (PRINTLD2 ARGt)

| PRINTLD2 LC21  = "C21"
| PRINTLD2 (LC22 ARGt)  = (String.concat ["C22", " ", (PRINTLD1 ARGt)
])
...
datatype ('a, 'b, 'c)  LD = LD of (Ostring * ('a , 'b , 'c) LD Option.option ref) | LC of ('a , 'b , 'c) TUPLETYPE3

fun EMBEDLD (qua, qub, quc) (C ARGt)  = (LC ((EMBEDTUPLETYPE3 (((fn ARGt =>
((fn (ARG1, ARG2) =>
ARG1) qua ARGt)
), (fn ARGt =>
((fn (ARG1, ARG2) =>
...
and PROJLD (qua, qub, quc) (LD (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJLD (qua, qub, quc) (LD (_, (ref (Option.SOME ARGt))))  = ((PROJLD (qua, qub, quc))
 ARGt)

| PROJLD (qua, qub, quc) (LC ARGt)  = (C ((PROJTUPLETYPE3 (((fn ARGt =>
((fn (ARG1, ARG2) =>
ARG1) qua ARGt)
), (fn ARGt =>
((fn (ARG1, ARG2) =>
...
fun OCCURLD (qua, qub, quc) ARG0 (LD (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURLD (qua, qub, quc) ARG0 (LD (_, (ref (Option.SOME ARG2))))  = ((OCCURLD (qua, qub, quc))
 ARG0 ARG2)

| OCCURLD (qua, qub, quc) ARG0 (LC ARG1)  = ((OCCURTUPLETYPE3 ((fn ARGv =>
(fn ARGt =>
(qua ARGv ARGt)
)), (fn ARGv =>
(fn ARGt =>
...
fun UNIFYLD (qua, qub, quc) (ARGt1, (LD (_, (ref (Option.SOME ARGt2))))) ARGtc  = ((UNIFYLD (qua, qub, quc))
 (ARGt1, ARGt2) ARGtc)

| UNIFYLD (qua, qub, quc) (ARGt1, (LD (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) ((OCCURLD (((fn (ARG1, ARG2) =>
ARG2) qua)
, ((fn (ARG1, ARG2) =>
ARG2) qub)
, ((fn (ARG1, ARG2) =>
...
| UNIFYLD (qua, qub, quc) ((LD (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = ((UNIFYLD (qua, qub, quc))
 (ARGt1, ARGt2) ARGtc)

| UNIFYLD (qua, qub, quc) ((ARGt1 as (LD (_, (ref Option.NONE)))), ARGt2) ARGtc  = ((UNIFYLD (qua, qub, quc))
 (ARGt2, ARGt1) ARGtc)

| UNIFYLD (qua, qub, quc) ((LC ARGt1), (LC ARGt2)) ARGtc  = ((UNIFYTUPLETYPE3 (((fn (ARGt1, ARGt2) =>
(fn ARGtc =>
(((fn (ARG1, ARG2) =>
ARG1) qua)
 (ARGt1, ARGt2) ARGtc)
...
fun PRINTLD (qua, qub, quc) (LD (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLD (qua, qub, quc) (LD (_, (ref (Option.SOME ARGt))))  = ((PRINTLD (qua, qub, quc))
 ARGt)

| PRINTLD (qua, qub, quc) (LC ARGt)  = (String.concat ["C", " ", ((PRINTTUPLETYPE3 ((fn ARGt =>
(qua ARGt)
), (fn ARGt =>
(qub ARGt)
), (fn ARGt =>
...
datatype OE = datatype E

datatype LE = LE of (Ostring * LE Option.option ref) | LC of (Lint , Lint , Lint) LD

fun EMBEDLE (C ARGt)  = (LC ((EMBEDLD (((fn ARGt =>
(EMBEDLint ARGt)
), (fn ARGt =>
(PROJLint ARGt)
)), ((fn ARGt =>
...
and PROJLE (LE (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJLE (LE (_, (ref (Option.SOME ARGt))))  = (PROJLE ARGt)

| PROJLE (LC ARGt)  = (C ((PROJLD (((fn ARGt =>
(EMBEDLint ARGt)
), (fn ARGt =>
(PROJLint ARGt)
)), ((fn ARGt =>
...
fun OCCURLE ARG0 (LE (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURLE ARG0 (LE (_, (ref (Option.SOME ARG2))))  = (OCCURLE ARG0 ARG2)

| OCCURLE ARG0 (LC ARG1)  = ((OCCURLD ((fn ARGv =>
(fn ARGt =>
(OCCURLint ARGv ARGt)
)), (fn ARGv =>
(fn ARGt =>
...
fun UNIFYLE (ARGt1, (LE (_, (ref (Option.SOME ARGt2))))) ARGtc  = (UNIFYLE (ARGt1, ARGt2) ARGtc)

| UNIFYLE (ARGt1, (LE (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) (OCCURLE ARG0 ARGt1)
)

| UNIFYLE ((LE (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = (UNIFYLE (ARGt1, ARGt2) ARGtc)

| UNIFYLE ((ARGt1 as (LE (_, (ref Option.NONE)))), ARGt2) ARGtc  = (UNIFYLE (ARGt2, ARGt1) ARGtc)

| UNIFYLE ((LC ARGt1), (LC ARGt2)) ARGtc  = ((UNIFYLD (((fn (ARGt1, ARGt2) =>
(fn ARGtc =>
(UNIFYLint (ARGt1, ARGt2) ARGtc)
)), (fn ARGv =>
(fn ARGt =>
...
fun PRINTLE (LE (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLE (LE (_, (ref (Option.SOME ARGt))))  = (PRINTLE ARGt)

| PRINTLE (LC ARGt)  = (String.concat ["C", " ", ((PRINTLD ((fn ARGt =>
(PRINTLint ARGt)
), (fn ARGt =>
(PRINTLint ARGt)
), (fn ARGt =>
