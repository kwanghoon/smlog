...
datatype LTerm = LTerm of (Ostring * LTerm Option.option ref) | LVar of Lstring | LLam of (Lstring , LTerm) TUPLETYPE2 | LApp of (LTerm , LTerm) TUPLETYPE2
...
datatype Predicate = PVar of string | PUniv of (Predicate * Predicate)

datatype OPredicate = datatype Predicate

datatype LPredicate = LPredicate of (Ostring * LPredicate Option.option ref) | LPVar of Lstring | LPUniv of (LPredicate , LPredicate) TUPLETYPE2

fun EMBEDLPredicate (PVar ARGt)  = (LPVar (EMBEDLstring ARGt)
)

| EMBEDLPredicate (PUniv ARGt)  = (LPUniv ((EMBEDTUPLETYPE2 (((fn ARGt =>
(EMBEDLPredicate ARGt)
), (fn ARGt =>
(PROJLPredicate ARGt)
)), ((fn ARGt =>
(EMBEDLPredicate ARGt)
...
and PROJLPredicate (LPredicate (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJLPredicate (LPredicate (_, (ref (Option.SOME ARGt))))  = (PROJLPredicate ARGt)

| PROJLPredicate (LPVar ARGt)  = (PVar (PROJLstring ARGt)
)

| PROJLPredicate (LPUniv ARGt)  = (PUniv ((PROJTUPLETYPE2 (((fn ARGt =>
(EMBEDLPredicate ARGt)
), (fn ARGt =>
(PROJLPredicate ARGt)
)), ((fn ARGt =>
...
fun OCCURLPredicate ARG0 (LPredicate (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURLPredicate ARG0 (LPredicate (_, (ref (Option.SOME ARG2))))  = (OCCURLPredicate ARG0 ARG2)

| OCCURLPredicate ARG0 (LPVar ARG1)  = (OCCURLstring ARG0 ARG1)

| OCCURLPredicate ARG0 (LPUniv ARG1)  = ((OCCURTUPLETYPE2 ((fn ARGv =>
(fn ARGt =>
(OCCURLPredicate ARGv ARGt)
)), (fn ARGv =>
(fn ARGt =>
(OCCURLPredicate ARGv ARGt)
))))
...
fun UNIFYLPredicate (ARGt1, (LPredicate (_, (ref (Option.SOME ARGt2))))) ARGtc  = (UNIFYLPredicate (ARGt1, ARGt2) ARGtc)

| UNIFYLPredicate (ARGt1, (LPredicate (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) (OCCURLPredicate ARG0 ARGt1)
)

| UNIFYLPredicate ((LPredicate (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = (UNIFYLPredicate (ARGt1, ARGt2) ARGtc)

| UNIFYLPredicate ((ARGt1 as (LPredicate (_, (ref Option.NONE)))), ARGt2) ARGtc  = (UNIFYLPredicate (ARGt2, ARGt1) ARGtc)

| UNIFYLPredicate ((LPVar ARGt1), (LPVar ARGt2)) ARGtc  = (UNIFYLstring (ARGt1, ARGt2) ARGtc)

| UNIFYLPredicate ((LPUniv ARGt1), (LPUniv ARGt2)) ARGtc  = ((UNIFYTUPLETYPE2 (((fn (ARGt1, ARGt2) =>
(fn ARGtc =>
(UNIFYLPredicate (ARGt1, ARGt2) ARGtc)
)), (fn ARGv =>
(fn ARGt =>
(OCCURLPredicate ARGv ARGt)
))), ((fn (ARGt1, ARGt2) =>
...
| UNIFYLPredicate (_, _) ARGtc  = (false, ARGtc)

fun PRINTLPredicate (LPredicate (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLPredicate (LPredicate (_, (ref (Option.SOME ARGt))))  = (PRINTLPredicate ARGt)

| PRINTLPredicate (LPVar ARGt)  = (String.concat ["PVar", " ", (PRINTLstring ARGt)
])

| PRINTLPredicate (LPUniv ARGt)  = (String.concat ["PUniv", " ", ((PRINTTUPLETYPE2 ((fn ARGt =>
(PRINTLPredicate ARGt)
), (fn ARGt =>
(PRINTLPredicate ARGt)
)))
 ARGt)
...
fun RELmember (ARG0 : Lstring, ARG1 : (Lstring , LPredicate) TUPLETYPE2 Llist, ARG2 : LPredicate)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS LPredicate (fn P : LPredicate =>
(SMLOG.EXISTS Lstring (fn X : Lstring =>
(SMLOG.EXISTS Llist (fn XPS : (Lstring , LPredicate) TUPLETYPE2 Llist =>
...
(OCCURLPredicate ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG1 (Lopcoco (TUPLECON2 ((TUPLECON2 (X, P))
, XPS))
)
 ARGtc)
)))
...
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLPredicate (ARG0, ARG1) ARGtc)
)) ARG2 P ARGtc)
)))
))
))
...
, (SMLOG.EXISTS LPredicate (fn P : LPredicate =>
(SMLOG.EXISTS LPredicate (fn WILD_1 : LPredicate =>
(SMLOG.EXISTS Lstring (fn X : Lstring =>
(SMLOG.EXISTS Llist (fn XPS : (Lstring , LPredicate) TUPLETYPE2 Llist =>
...
, ((fn (Option.SOME ARG2) =>
(EMBEDLPredicate ARG2)
 | Option.NONE =>
(LPredicate ((SMLOG.freshString ())
, (ref Option.NONE)
))
) ARG2)
))
...
fun RELJ (ARG0 : (Lstring , LPredicate) TUPLETYPE2 Llist, ARG1 : LTerm, ARG2 : LPredicate)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Llist (fn ENV : (Lstring , LPredicate) TUPLETYPE2 Llist =>
(SMLOG.EXISTS LPredicate (fn P : LPredicate =>
(SMLOG.EXISTS Lstring (fn X : Lstring =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
...
, (SMLOG.EXISTS LTerm (fn E : LTerm =>
(SMLOG.EXISTS Llist (fn ENV : (Lstring , LPredicate) TUPLETYPE2 Llist =>
(SMLOG.EXISTS LPredicate (fn P1 : LPredicate =>
(SMLOG.EXISTS LPredicate (fn P2 : LPredicate =>
(SMLOG.EXISTS Lstring (fn X : Lstring =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
...
(fn ARGtc =>
(UNIFYLPredicate (ARG0, ARG1) ARGtc)
)) ARG2 (LPUniv (TUPLECON2 (P1, P2))
)
 ARGtc)
)))
, (RELJ ((Lopcoco (TUPLECON2 ((TUPLECON2 (X, P1))
, ENV))
)
, E, P2))
))
...
, (SMLOG.EXISTS LTerm (fn E1 : LTerm =>
(SMLOG.EXISTS LTerm (fn E2 : LTerm =>
(SMLOG.EXISTS Llist (fn ENV : (Lstring , LPredicate) TUPLETYPE2 Llist =>
(SMLOG.EXISTS LPredicate (fn P1 : LPredicate =>
(SMLOG.EXISTS LPredicate (fn P2 : LPredicate =>
...
, (RELJ (ENV, E1, (LPUniv (TUPLECON2 (P2, P1))
)
))
))
, (RELJ (ENV, E2, P2))
...
fun J (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
