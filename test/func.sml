...
fun RELapply (ARG0 : (Lint , Lint) Lmigt, ARG1 : Lint, ARG2 : Lint)  = (SMLOG.STEP (SMLOG.EXISTS Lmigt (fn F : (Lint , Lint) Lmigt =>
(SMLOG.EXISTS Lint (fn FLATAPP_1 : Lint =>
(SMLOG.EXISTS Lint (fn X : Lint =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
((UNIFYLmigt (((fn (ARGt1, ARGt2) =>
(fn ARGtc =>
...
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) ARG2 FLATAPP_1 ARGtc)
)))
, (fn ARGtc =>
(((SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) FLATAPP_1 ((SMLOG.doAppUnderSubst (fn _ =>
(EMBEDLint ((SMLOG.doAppUnderSubst (fn _ =>
((fn ARGt =>
(PROJLmigt (((fn ARGt =>
(EMBEDLint ARGt)
), (fn ARGt =>
...
fun apply (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
...
fun RELmap (ARG0 : (Lint , Lint) Lmigt, ARG1 : Lint Llist, ARG2 : Lint Llist)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Lmigt (fn G : (Lint , Lint) Lmigt =>
...
, (SMLOG.EXISTS Lint (fn FLATAPP_2 : Lint =>
(SMLOG.EXISTS Lmigt (fn G : (Lint , Lint) Lmigt =>
(SMLOG.EXISTS Lint (fn X : Lint =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG2 (Lopcoco (TUPLECON2 (FLATAPP_2, YS))
)
 ARGtc)
)))
, (fn ARGtc =>
...
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) FLATAPP_2 ((SMLOG.doAppUnderSubst (fn _ =>
(EMBEDLint ((SMLOG.doAppUnderSubst (fn _ =>
((fn ARGt =>
(PROJLmigt (((fn ARGt =>
(EMBEDLint ARGt)
...
fun map (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
fun RELapply2 (ARG0 : (Lint , Lint) Lmigt, ARG1 : Lint, ARG2 : Lint)  = (SMLOG.STEP (SMLOG.EXISTS Lmigt (fn F : (Lint , Lint) Lmigt =>
(SMLOG.EXISTS Lint (fn X : Lint =>
...
fun apply2 (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
fun RELapply3 (ARG0 : (Lint , Lint) Lmigt, ARG1 : Lint, ARG2 : Lint)  = (SMLOG.STEP (SMLOG.EXISTS Lmigt (fn F : (Lint , Lint) Lmigt =>
(SMLOG.EXISTS Lint (fn FLATAPP_3 : Lint =>
(SMLOG.EXISTS Lint (fn X : Lint =>
(SMLOG.EXISTS Lint (fn Y : Lint =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
...
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) FLATAPP_3 ((SMLOG.doAppUnderSubst (fn _ =>
(EMBEDLint ((SMLOG.doAppUnderSubst (fn _ =>
((fn ARGt =>
(PROJLmigt (((fn ARGt =>
(EMBEDLint ARGt)
...
fun apply3 (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
fun RELapply4 (ARG0 : (Lint , Lint) Lmigt, ARG1 : Lint, ARG2 : Lint)  = (SMLOG.STEP (SMLOG.EXISTS Lmigt (fn F : (Lint , Lint) Lmigt =>
(SMLOG.EXISTS Lint (fn FLATAPP_4 : Lint =>
(SMLOG.EXISTS Lint (fn X : Lint =>
(SMLOG.EXISTS Lint (fn Y : Lint =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
...
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) ARG2 FLATAPP_4 ARGtc)
)))
, (fn ARGtc =>
(((SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) FLATAPP_4 ((SMLOG.doAppUnderSubst (fn _ =>
(EMBEDLint ((SMLOG.doAppUnderSubst (fn _ =>
((fn ARGt =>
(PROJLmigt (((fn ARGt =>
(EMBEDLint ARGt)
...
fun apply4 (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
