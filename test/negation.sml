...
fun RELzero (ARG0 : Lint)  = (SMLOG.STEP (fn ARGtc =>
...
fun RELpositive (ARG0 : Lint)  = (SMLOG.STEP (SMLOG.EXISTS Lint (fn N : Lint =>
...
fun RELp (ARG0 : Lint)  = (SMLOG.STEP (SMLOG.EXISTS Lint (fn X : Lint =>
(SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
...
fun RELset (ARG0 : Lint, ARG1 : Lint Llist, ARG2 : Lint Llist)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Lint (fn X : Lint =>
...
fun set (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
