...
fun RELmap (ARG0 : (Lint , Lint) Lmigt, ARG1 : Lint Llist, ARG2 : Lint Llist)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Lmigt (fn F : (Lint , Lint) Lmigt =>
...
, (SMLOG.EXISTS Lmigt (fn F : (Lint , Lint) Lmigt =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG2 (Lopcoco (TUPLECON2 (FLATAPP_3, YS))
)
 ARGtc)
)))
, (fn ARGtc =>
