...
datatype ('a0, 'a1, 'a2)  RECORDTYPEl1l2l3 = RECORDTYPEl1l2l3 of (Ostring * ('a0 , 'a1 , 'a2) RECORDTYPEl1l2l3 Option.option ref) | RECORDCONl1l2l3 of {l1:'a0, l2:'a1, l3:'a2}

fun EMBEDRECORDTYPEl1l2l3 (qua0, qua1, qua2) ARGt0  = ((fn {l1 = l1, l2 = l2, l3 = l3} =>
(RECORDCONl1l2l3 {l1 = ((fn (ARG1, ARG2) =>
ARG1) qua0 l1)
, l2 = ((fn (ARG1, ARG2) =>
ARG1) qua1 l2)
, l3 = ((fn (ARG1, ARG2) =>
...
and PROJRECORDTYPEl1l2l3 (qua0, qua1, qua2) (RECORDTYPEl1l2l3 (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJRECORDTYPEl1l2l3 (qua0, qua1, qua2) (RECORDTYPEl1l2l3 (_, (ref (Option.SOME ARGt))))  = ((PROJRECORDTYPEl1l2l3 (qua0, qua1, qua2))
 ARGt)

| PROJRECORDTYPEl1l2l3 (qua0, qua1, qua2) (RECORDCONl1l2l3 ARGt0)  = ((fn {l1 = l1, l2 = l2, l3 = l3} =>
{l1 = ((fn (ARG1, ARG2) =>
ARG2) qua0 l1)
, l2 = ((fn (ARG1, ARG2) =>
ARG2) qua1 l2)
...
fun OCCURRECORDTYPEl1l2l3 (qua0, qua1, qua2) ARG0 (RECORDTYPEl1l2l3 (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURRECORDTYPEl1l2l3 (qua0, qua1, qua2) ARG0 (RECORDTYPEl1l2l3 (_, (ref (Option.SOME ARG2))))  = ((OCCURRECORDTYPEl1l2l3 (qua0, qua1, qua2))
 ARG0 ARG2)

| OCCURRECORDTYPEl1l2l3 (qua0, qua1, qua2) ARG0 (RECORDCONl1l2l3 ARG1)  = ((fn ARGv =>
(fn {l1 = l1, l2 = l2, l3 = l3} =>
((fn true =>
true | false =>
(qua2 ARGv l3)
) ((fn true =>
...
fun UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2) (ARGt1, (RECORDTYPEl1l2l3 (_, (ref (Option.SOME ARGt2))))) ARGtc  = ((UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2))
 (ARGt1, ARGt2) ARGtc)

| UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2) (ARGt1, (RECORDTYPEl1l2l3 (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) ((OCCURRECORDTYPEl1l2l3 (((fn (ARG1, ARG2) =>
ARG2) qua0)
, ((fn (ARG1, ARG2) =>
ARG2) qua1)
, ((fn (ARG1, ARG2) =>
...
| UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2) ((RECORDTYPEl1l2l3 (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = ((UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2))
 (ARGt1, ARGt2) ARGtc)

| UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2) ((ARGt1 as (RECORDTYPEl1l2l3 (_, (ref Option.NONE)))), ARGt2) ARGtc  = ((UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2))
 (ARGt2, ARGt1) ARGtc)

| UNIFYRECORDTYPEl1l2l3 (qua0, qua1, qua2) ((RECORDCONl1l2l3 ARGt1), (RECORDCONl1l2l3 ARGt2)) ARGtc  = ((fn ({l1 = l11, l2 = l21, l3 = l31}, {l1 = l12, l2 = l22, l3 = l32}) =>
((fn (true, ARGtc) =>
(((fn (ARG1, ARG2) =>
ARG1) qua2)
 (l31, l32) ARGtc)
...
fun PRINTRECORDTYPEl1l2l3 (qua0, qua1, qua2) (RECORDTYPEl1l2l3 (ARGs, (ref Option.NONE)))  = ARGs
| PRINTRECORDTYPEl1l2l3 (qua0, qua1, qua2) (RECORDTYPEl1l2l3 (_, (ref (Option.SOME ARGt))))  = ((PRINTRECORDTYPEl1l2l3 (qua0, qua1, qua2))
 ARGt)

| PRINTRECORDTYPEl1l2l3 (qua0, qua1, qua2) (RECORDCONl1l2l3 ARGt0)  = ((fn {l1 = l1, l2 = l2, l3 = l3} =>
(String.concat ["{", (SMLOG.intersperse "," [(String.concat ["l1", "=", (qua0 l1)
])
, (String.concat ["l2", "=", (qua1 l2)
])
, (String.concat ["l3", "=", (qua2 l3)
])
])
, "}"])
) ARGt0)
...
datatype R = C of {l1:int, l2:string, l3:int list}

datatype OR = datatype R

datatype LR = LR of (Ostring * LR Option.option ref) | LC of (Lint , Lstring , Lint Llist) RECORDTYPEl1l2l3

fun EMBEDLR (C ARGt)  = (LC ((EMBEDRECORDTYPEl1l2l3 (((fn ARGt =>
(EMBEDLint ARGt)
), (fn ARGt =>
(PROJLint ARGt)
)), ((fn ARGt =>
...
and PROJLR (LR (_, (ref Option.NONE)))  = raise SMLOG.ProjectionError
| PROJLR (LR (_, (ref (Option.SOME ARGt))))  = (PROJLR ARGt)

| PROJLR (LC ARGt)  = (C ((PROJRECORDTYPEl1l2l3 (((fn ARGt =>
(EMBEDLint ARGt)
), (fn ARGt =>
(PROJLint ARGt)
)), ((fn ARGt =>
...
fun OCCURLR ARG0 (LR (ARG1, (ref Option.NONE)))  = (op= (ARG0, ARG1))

| OCCURLR ARG0 (LR (_, (ref (Option.SOME ARG2))))  = (OCCURLR ARG0 ARG2)

| OCCURLR ARG0 (LC ARG1)  = ((OCCURRECORDTYPEl1l2l3 ((fn ARGv =>
(fn ARGt =>
(OCCURLint ARGv ARGt)
)), (fn ARGv =>
(fn ARGt =>
...
fun UNIFYLR (ARGt1, (LR (_, (ref (Option.SOME ARGt2))))) ARGtc  = (UNIFYLR (ARGt1, ARGt2) ARGtc)

| UNIFYLR (ARGt1, (LR (ARG0, (ARGr as (ref Option.NONE))))) ARGtc  = ((fn true =>
(false, ARGtc) | false =>
(true, (SMLOG.extendTc ARGtc ARGr ARGt1)
)) (OCCURLR ARG0 ARGt1)
)

| UNIFYLR ((LR (_, (ref (Option.SOME ARGt1)))), ARGt2) ARGtc  = (UNIFYLR (ARGt1, ARGt2) ARGtc)

| UNIFYLR ((ARGt1 as (LR (_, (ref Option.NONE)))), ARGt2) ARGtc  = (UNIFYLR (ARGt2, ARGt1) ARGtc)

| UNIFYLR ((LC ARGt1), (LC ARGt2)) ARGtc  = ((UNIFYRECORDTYPEl1l2l3 (((fn (ARGt1, ARGt2) =>
(fn ARGtc =>
...
fun PRINTLR (LR (ARGs, (ref Option.NONE)))  = ARGs
| PRINTLR (LR (_, (ref (Option.SOME ARGt))))  = (PRINTLR ARGt)

| PRINTLR (LC ARGt)  = (String.concat ["C", " ", ((PRINTRECORDTYPEl1l2l3 ((fn ARGt =>
(PRINTLint ARGt)
), (fn ARGt =>
(PRINTLstring ARGt)
), (fn ARGt =>
