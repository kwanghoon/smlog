...
fun RELedge (ARG0 : Lstring, ARG1 : Lstring)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
...
fun edge (ARG0, ARG1)  = ((fn (ARG0, ARG1) =>
...
fun RELpath (ARG0 : Lstring, ARG1 : Lstring, ARG2 : Lstring Llist)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Lstring (fn X : Lstring =>
...
, (SMLOG.EXISTS Llist (fn Nodes : Lstring Llist =>
(SMLOG.EXISTS Lstring (fn X : Lstring =>
(SMLOG.EXISTS Lstring (fn Y : Lstring =>
(SMLOG.EXISTS Lstring (fn Z : Lstring =>
...
(OCCURLstring ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG2 (Lopcoco (TUPLECON2 (X, Nodes))
)
 ARGtc)
)))
, (RELedge (X, Y))
...
fun path (ARG0, ARG1, ARG2)  = ((fn (ARG0, ARG1, ARG2) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
