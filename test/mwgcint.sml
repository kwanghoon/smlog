...
fun RELmember (ARG0 : Lint, ARG1 : Lint Llist, ARG2 : Lbool)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Lint (fn X : Lint =>
...
fun RELmove (ARG0 : Lint, ARG1 : Lint)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
(UNIFYLint (ARG0, ARG1) ARGtc)
)) ARG0 (THEint 1010)
...
fun RELpath (ARG0 : Lint Llist, ARG1 : Lint Llist)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Llist (fn P : Lint Llist =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG1 (Lopcoco (TUPLECON2 ((THEint 0)
, (Lnil)
))
)
 ARGtc)
...
, (SMLOG.EXISTS Llist (fn P1 : Lint Llist =>
(SMLOG.EXISTS Llist (fn P2 : Lint Llist =>
(SMLOG.EXISTS Lint (fn S1 : Lint =>
(SMLOG.EXISTS Lint (fn S2 : Lint =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
((UNIFYLlist ((fn (ARGt1, ARGt2) =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG1 (Lopcoco (TUPLECON2 (S2, P2))
)
 ARGtc)
)))
, (RELmove (S1, S2))
))
, (RELmember (S2, P1, (Lfalse)
))
))
, (RELpath ((Lopcoco (TUPLECON2 (S2, (Lopcoco (TUPLECON2 (S1, P1))
)
))
)
, P2))
...
fun RELsolve (ARG0 : Lint Llist)  = (SMLOG.STEP (SMLOG.EXISTS Llist (fn P : Lint Llist =>
(SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
(SMLOG.doUnify (fn (ARG0, ARG1) =>
(fn ARGtc =>
((UNIFYLlist ((fn (ARGt1, ARGt2) =>
...
(OCCURLint ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG0 (Lopcoco (TUPLECON2 ((THEint 1111)
, P))
)
 ARGtc)
)))
, (RELpath ((Lopcoco (TUPLECON2 ((THEint 1111)
, (Lnil)
))
)
, P))
