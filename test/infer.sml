...
(SMLOG.EXISTS Lty (fn T : Lty =>
(SMLOG.EXISTS TUPLETYPE2 (fn WILD_2 : (Lstring , Lty) TUPLETYPE2 =>
(SMLOG.EXISTS Lstring (fn X : Lstring =>
...
(OCCURLty ARGv ARGt)
 ...
 (ARG0, ARG1) ARGtc)
)) ARG0 (Lopcoco (TUPLECON2 (WILD_2, E))
)
 ARGtc)
)))
, (fn ARGtc =>
...
fun RELinfer (ARG0 : (Lstring , Lty) TUPLETYPE2 Llist, ARG1 : Lty Llist, ARG2 : Lterm, ARG3 : Lty)  = (SMLOG.STEP (SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ ((SMLOG.DISJ (SMLOG.FALSE, (SMLOG.EXISTS Llist (fn G : (Lstring , Lty) TUPLETYPE2 Llist =>
(SMLOG.EXISTS Lty (fn T : Lty =>
(SMLOG.EXISTS Lstring (fn V : Lstring =>
...
(SMLOG.EXISTS Llist (fn G : (Lstring , Lty) TUPLETYPE2 Llist =>
(SMLOG.EXISTS Lty (fn T : Lty =>
(SMLOG.EXISTS Lty (fn T' : Lty =>
(SMLOG.EXISTS Lstring (fn V : Lstring =>
(SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ ((SMLOG.CONJ (SMLOG.TRUE, (fn ARGtc =>
...
, (RELmember (G, V, (LFun (TUPLECON2 ((Lopcoco (TUPLECON2 (T, D))
)
, T'))
)
))
...
, (RELinfer ((Lopcoco (TUPLECON2 ((TUPLECON2 (V, T))
, G))
)
, D, M, T'))
))
...
(fn ARGtc =>
(UNIFYLty (ARG0, ARG1) ARGtc)
)) ARG3 (LFun (TUPLECON2 ((Lopcoco (TUPLECON2 (T, D))
)
, T'))
)
 ARGtc)
...
, (RELinfer (G, (Lopcoco (TUPLECON2 (T, D))
)
, M1, T'))
))
))
...
, (RELinfer (G, (Lnil)
, M1, (LFun (TUPLECON2 ((Lopcoco (TUPLECON2 (T, D))
)
, T'))
)
))
...
fun infer (ARG0, ARG1, ARG2, ARG3)  = ((fn (ARG0, ARG1, ARG2, ARG3) =>
(SMLOG.mapS (List.map (fn ARGtc =>
((fn _ =>
((fn ARGres =>
((fn _ =>
...
, (PRINTLty ARG3)
 ...
 (RELinfer (ARG0, ARG1, ARG2, ARG3) (fn _ =>
()))
)
) (((fn (Option.SOME ARG0) =>
((EMBEDLlist ((fn ARGt =>
